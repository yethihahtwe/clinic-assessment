...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::table('questions')->insert([
            ...
            [
            'name' => 'Clinic Incharge',
            'domain_id' => 2,
            'subdomain_id' => null,
            'slug' => 'd2q2'
            ],
            [
            'name' => '2nd Clinic Incharge',
            'domain_id' => 2,
            'subdomain_id' => null,
            'slug' => 'd2q3'
            ],
            ...
            [
            'name' => 'What are the contraceptive methods?(COC, POP, Depo, Implants, IUD, Codoms , Diaphragm, Vasectomy, Tubal Ligation, LAM, Withdrawl, Natural Family Planning)',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q3'
            ],
            ...
            [
            'name' => 'ကိုယ်ဝန်ဆောင်စောင့်ရှောက်မှုပေးရမည့်အချိန်ကာလ (ANC Timing): 1st Visit - < 14 wk; 2nd Visit - 15 to 28 wk; 3rd Visit - 29 to 34 wk ; 4th Visit - >= 35 wk',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q5'
            ],
            [
            'name' => 'Abdominal examination ပြုလုပ်စဥ် ပါဝင်ရမည့် အချက်များကို သင်မှတ်မိသလောက် ဖော်ပြပါ။ ၁) သားအိမ်အရွယ်အစားကိုကြည့်၍ ကိုယ်ဝန်သက်တမ်းကိုသတ်မှတ်ပါ။ ၂) သန္ဓေသား အရေအတွက်ကို စမ်းသပ်ပါ။ ၃) symphysis-fundus အမြင့်ကိုတိုင်းတာပါ။ ၄) သန္ဓေသား၏ lie နှင့် presentation ကိုအကဲဖြတ်ပါ။ ၅) ရေမြွှာရည်ပမာဏကိုအကဲဖြတ်ပါ။ ၆) သန္ဓေသားနှလုံးခုန်သံကိုနားထောင်ပါ။ ၇) သန္ဓေသားလှုပ်ရှားမှုများကိုစစ်ဆေးပါ။',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q6'
            ],
            [
            'name' => 'ကလေးမမွေးဖွားမီသွေးသွန်ခြင်းကို ဖြစ်စေသည့်အကြောင်းရင်းများ (အနည်းဆုံး ၃ချက်ကို ဖြေသင့်ပါသည်) ၁) အချင်းစောကွာခြင်း ၂) အချင်းရှေ့ရောက်ခြင်း ၄) သားအိမ်ကွဲခြင်း ၅) ကလေးအသေမွေးခြင်း ၆) သားအိမ်ခေါင်းဒဏ်ရာရခြင်း',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q7'
            ],
            [
            'name' => 'ကလေးမွေးဖွားခြင်းတတိယအဆင့်ကို ပြုလုပ်ရမည့် အချက်များကို မှတ်မိသလောက် ဖော်ပြပါ။ ၁) သားအိမ်လှုံ့ဆော်သောဆေးပေးခြင်း ၂) ၁ မိနစ်မှ ၃ မိနစ်အတွင်း ချက်ကြိုးအား clamp လုပ်ခြင်း ၃) သားအိမ်ကိုလက်တဖက်ဖြင့် ပင့်တင်၍ ချက်ကြိုးကို ထိန်း၍ အချင်း ဆွဲထုတ်ခြင်း  (Controlled cord traction) ၄) အချင်းမွေးဖွားခြင်း ပြည့်စုံမှု ရှိမရှိ စစ်ဆေးခြင်း ၅) သားအိမ်ကိုနှိပ်နယ်ပေးခြင်း (Massage of theh uterine fundus) ၆) အကယ်၍ အချင်းမကွာပါက အချင်းကွာ မချိန် ၁ နာရီအထိ စောင့်ကြည့်ခြင်း',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q8'
            ],
            ...
            [
            'name' => 'Causes of PPH (မွေးဖွားပြီး သွေးသွန်ခြင်းကို ဖြစ်စေသော အကြောင်းအရာများ)  ၁) သားအိမ်ပြန်မကျုံ့နိုင်ခြင်း (Uterine atony) ၂) သားအိမ်ဒဏ်ရာရခြင်း (Trauma/ intra-abdominal injury) ၃) အချင်းကျန်ခြင်း သို့မဟုတ် အချင်းမူမမှန်ဖြစ်ခြင်း (Retained placenta or placental abnormalities) ၄) Coagulopathy',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q10'
            ],
            [
            'name' => 'မွေးပြီးစောင့်ရှောက်မှုပေးရမည့်အချိန်ကာလ ၁) ပထမအကြိမ် >> မွေးဖွားပြီး ၂၄ နာရီအတွင်း (အိမ်တွင် သို့မဟုတ် ဆေးခန်းတွင်) ၂) ဒုတိယအကြိမ် >> မွေးဖွားပြီး ၂ - ၇ ရက် အတွင်း ၃) တတိယအကြိမ် >> မွေးဖွားပြီး ၈ - ၄၂ ရက် အတွင်း',
            'domain_id' => 7,
            'subdomain_id' => 18,
            'slug' => 'd7q11'
            ],
            ...
            [
            'name' => 'Common causes of under 5 mortality in Myanmar? (neonatal & > neonate U5)- Neonatal mortality - 3 causes: sepsis and pneumonia, prematurity, birth asphyxia  - U5 motality: - 2 causes: pneumonia, diarrhoea၂)',
            'domain_id' => 8,
            'subdomain_id' => 20,
            'slug' => 'd8q2'
            ],
            ...
            [
            'name' => 'Assess the knowledge of the breastfeeding for Normal infant 1) How many times breastfeed in 24 hours? 8 times / 3 hourly  2) How many months mom should offer breastfeeding? full 6 months 3) While offering these months do we need to add other fluids, water or food? No food even water should not give to baby within 6 months of age except breastfeeding. (We can give ORS or medication if necessary)',
            'domain_id' => 8,
            'subdomain_id' => 23,
            'slug' => 'd8q33'
            ],
            ...
            [
            'name' => 'OPD caseload (Clinic and Mobile Team)',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q3'
            ],
            ...
            [
            'name' => 'Mobile form for mobile team',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q5'
            ],
            [
            'name' => 'ANC, Delivery, PNC Chart',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q6'
            ],
            ...
            [
            'name' => 'HIS Indicator Reporting',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q22'
            ],
            [
            'name' => 'Referral form (ICMV/EMOC/ECC/Other)',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q23'
            ],
            ...
            [
            'name' => 'Malaria Patient Register',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q27'
            ],
            [
            'name' => 'HE Attendance Form / HE Form',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q28'
            ],
            [
            'name' => 'IYCF Counselling Form',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q29'
            ],
            [
            'name' => 'ICMV Referral Register',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q30'
            ],
            ...
            [
            'name' => 'Pneumonia and Diarrhoea Treatment Register',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q32'
            ],
            [
            'name' => 'Recording and Reporting Guidelines',
            'domain_id' => 9,
            'subdomain_id' => null,
            'slug' => 'd9q33'
            ],
